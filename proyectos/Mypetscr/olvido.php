  ...
  <div class="content">
   ...
   <section class="content"> 
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-md-10 col-sm-offset-1 col-md-offset-1">
        
        
        <form action="php\obtener\olvidar.php" method="POST" role="form">
          <fieldset>
            <h4> "Por favor, introduzca la dirección de correo electrónico para su cuenta. Se le enviará un código de verificación. Una vez que lo haya recibido, podrá seleccionar una nueva contraseña para su cuenta."  </h4>
            <hr class="colorgraph">
            ...
            <div class="row">
             ...
             <div class="g-recaptcha" data-sitekey="Your public reCaptcha key"></div>
                ...
                <a href="registro.php" class="text-center">TENGO UNA CUENTA</a>
