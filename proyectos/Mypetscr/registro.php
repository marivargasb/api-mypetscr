...
<head>
  ...
  <link rel="stylesheet" href="css/estilos-add-clientes-copia.css">
  ...
  <div class="content">
   ...
   <section class="content"> 
      ...
      <div class="row">
          ...
          <div class="registe  col-xs-12 col-sm-8  col-lg-5 col-sm-offset-2  col-lg-offset-4 ">
              <div class="register-logo">
                <a href="mypetscr.php" ><b>Mypets</b>CR</a>
              </div>
              ...
              <div class="register-box-body">
                <p class="login-box-msg">Registrar un nuevo miembro </p>
                            ...
                            <div class="card card-inverse card-info">
                                <img class="img-responsive" src="https://www.planetacurioso.com/wp-content/uploads/2012/08/animalitos-arrepentidos-perdon2.jpg">
                                <div class="card-block">
                                    <figure class="profile profile-inline">
                                      
                                    </figure>
                                    <h4 class="card-title ">ENTRA A NUESTRAS PAGINA </h4>
                                    <div class="card-text">
                                     Entra mira todas las opciones que tienes
                                    </div>
                                </div>
    ...
    <div class="row" style="margin-top:20px">
        ...
        <form  action="" method="POST" class="form-horizontal" role="form" autocomplete="on">
          <fieldset>
            ...
            <input type="text" name="user1" id="user1" class="form-control input-lg user1 " placeholder="Username" required>
            </div>
            <div class="form-group">
            <input type="password" name="passworde1" id="passworde1" class="form-control input-lg passworde1" placeholder="Contraseña" required>
            </div>
            ...
            <div class="row">
             ...
             <input  type="button"       onclick="USER.login()"   class="btn btn-lg btn-success btn-block"  value="Iniciar Sesion">
     ...
     <div class="modal fade" id="t_and_c_m2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-title" id="myModalLabel2"> INGRESAR</h4>
          </div>
          <div class="modal-body">
   ...
   <div class="container">
    ...
    <div class="row" style="margin-top:20px" >
        ...
        <form id="form_users_save" name="form_users_save" action="" method="POST" class="form-horizontal" role="form" autocomplete="on" >
          ...
          <div class="col-xs-12 col-sm-6 col-md-6">
              <div class="form-group">
                <input type="text" name="apellido2" id="apellido2" class="form-control input-lg" placeholder="Segundo Apellido " tabindex="3">
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6">
              <div class="form-group">
                <input type="text" name="username" id="usernames" class="form-control input-lg" placeholder="Username" tabindex="4">
              </div>
            </div>
          </div>
          <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-6">
              <div class="form-group">
                <input type="password" name="password" id="passwords" class="form-control input-lg" placeholder="Contraseña " tabindex="5">
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6">
              <div class="form-group">
                <input type="password" name="password2" id="password2" class="form-control input-lg" placeholder="Confirmar Contraseña" tabindex="5">
              </div>
            </div>
          </div>
          <hr class="colorgraph">
          <div class="row">
            ...
            <input  type="button" onclick="USER.saveUser()" value="Registrar" class="btn btn-primary btn-block btn-lg" tabindex="7"/>
            </div>
