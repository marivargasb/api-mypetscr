...
<body>
<section class="menu cid-qyTfslPCyP" once="menu" id="menu1-e" data-rv-view="166">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="mypetscr.php">MYPETSCR</a></span>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
                    <a class="nav-link link text-white display-4" href="mypetscr.php"></a>
                </li>
                <li class="nav-item">
...
<section class="engine"><a href="https://mobirise.co/d">free web software</a></section><section class="cid-qyTfsmV6ah mbr-fullscreen" data-bg-video="http://www.youtube.com/watch?v=uNCr7NdOJgw" id="header2-f" data-rv-view="168">
...
<section class="cid-qyTfsnQNlP" id="footer1-g" data-rv-view="172">
    ...
    <div class="container">
        <div class="media-container-row content text-white">
            ...
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                ...
                <p class="mbr-text">&nbsp; &nbsp; &nbsp;COSTA RICA &nbsp;<br>CIUDAD QUESADA</p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <h5 class="pb-3">
                    Contacts
                ...
                <p class="mbr-text">
                    Email: mypetscr@gmail.com<br>Phone: +(506) 84267250<br>Fax: + (506) 26457250</p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <h5 class="pb-3">
                    Links
                </h5>
                <p class="mbr-text">Login<br>Registro<br>Sobre nosotros</p>
            </div>
        </div>
            ...
            <div class="media-container-row mbr-white">
                <div class="col-sm-6 copyright">
                    <p class="mbr-text mbr-fonts-style display-7">
                        © Copyright 2017 MypetsCR - All Rights Reserved
                    </p>
                </div>
                <div class="col-md-6">
