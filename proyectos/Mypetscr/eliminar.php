            ...
            <div class="box-body">
                    ...
                    <div class="small-box bg-red">
                      ...
                      <a href="#" class="small-box-footer">
                        QUIERES ELIMINAR TU CUENTA ESTAS SON LAS COSAS QUE DEBES SABES 
                      </a>
                    </div>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-primary">
              <div class="box-header">
                ...
                <h3 class="box-title">QUE PASA SI BORRO MI CUENTA</h3>
              ...
              <div class="box-body">
                ...
                <ul class="todo-list">
                  <li>
                    ...
                    <!-- Emphasis label -->
                    <small class="label label-danger"><i class="fa fa-clock-o"></i> al eliminar la cuenta perdera todo lo que tenga guardado</small>
                  ...
                  <li>
                    ...
                    <small class="label label-info"><i class="fa fa-clock-o"></i> Sus comentarios permaneseran pero no se mostrara su perfil</small>
                  ...
                  <li>
                    ...
                    <span class="text">Calificacion </span>
                    <small class="label label-warning"><i class="fa fa-clock-o"></i> Sus calificaciones permaneseran pero no se mostrara su perfil</small>
                    <div class="tools">
                  ...
                  <li>
                    ...
                    <span class="text">Su Negocio</span>
                    <small class="label label-success"><i class="fa fa-clock-o"></i> Su negocio sera eliminado de toda nuestra pagina</small>
                  ...
                  <li>
                    ...
                    <span class="text">Comentarios en su negocio </span>
                    <small class="label label-primary"><i class="fa fa-clock-o"></i> Todos los comentarios seran eliminados</small>
                    <div class="tools">
                      <i class="fa fa-edit"></i>
                      <i class="fa fa-trash-o"></i>
                    </div>
                  ...
                  <li>
                    ...
                    <small class="label label-default"><i class="fa fa-clock-o"></i> Si decea volver va a tener que iniciar de nuevo</small>
              ...
              <button type="button" onclick="USER.delete()"  class="btn btn-danger pull-right"><i class="fa  fa-warning "></i> <a href="php\borrar\b-usuario.php?id="> ELIMINAR LA CUENTA  </a></button>
          </form>
          </div>
